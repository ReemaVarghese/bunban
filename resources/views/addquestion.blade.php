...
<tr>
    <td>Question</td>
    <td><input type="text" class="form-control" name="que" required></td>
</tr>
<tr>
    <td>Option 1</td>
    <td><input type="text" class="form-control" name="op1" required></td>
</tr>
<tr>
    <td>Option 2</td>
    <td><input type="text" class="form-control" name="op2" required ></td>
</tr>
<tr>
    <td>Option 3</td>
    <td><input type="text" class="form-control" name="op3" required ></td>
</tr>
<tr>
    <td>Option 4</td>
    <td><input type="text" class="form-control" name="op4" required ></td>
</tr>
<tr>
    <td>Answer</td>
    <td><input type="text" class="form-control" name="ans" required></td>
</tr>
<tr>
    <td></td>
